...
export default function FastagSection() {
  ...
  const cardBorderVariants = {
    hover: {
      borderColor: "#6467f2",
      boxShadow:
        "0 30px 60px -15px rgba(0,0,0,0.45), 0 0 0 2px rgba(100, 103, 242, 0.2)",
      transition: {
        duration: 0.3,
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto container-padding">
        <div className="text-center mb-14">
          ...
          >
            Integrated vehicle tracking, fuel monitoring, and toll management
            systems for fleet owners and individual users.
          </motion.p>
        </div>
